// genero un numero random da 1 a 6 per l'utente con prompt (BONUS)
let userScore = parseInt(
  prompt("E' il tuo turno di lanciare il dado! Inserisci un numero da 1 a 6")
);
